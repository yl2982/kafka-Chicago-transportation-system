...
CREATE TABLE turnstile (
    ...
    KAFKA_TOPIC='turstile', VALUE_FORMAT='avro', key='STATION_ID'
);

CREATE TABLE turnstile_summary
WITH (
    KAFKA_TOPIC='TUNRSTILE_SUMMARY', VALUE_FORMAT='json'
) AS SELECT STATION_ID, STATION_NAME, COUNT(STATION_ID) as 
COUNT FROM turnstile GROUP BY STATION_ID, STATION_NAME;
"""
